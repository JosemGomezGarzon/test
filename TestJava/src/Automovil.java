...
public class Automóvil {
    ...
    private Automóvil.tipoMotor tipoMotor;
    /**
    ...
    */
    Automóvil(String marca, int modelo, int motor, tipoCom tipoCombustible, tipoA tipoAutomóvil, int númeroPuertas, int cantidadAsientos, int velocidadMáxima, tipoColor color, tipoMotor motorAuto) {
        this.tipoMotor = motorAuto;
        this.marca = marca;
        this.modelo = modelo;
        this.motor = motor;
    ...
    * @param marca Parámetro que define la marca de un automóvil
    */
    void setTipoMotor(tipoMotor motorAuto) {
    ...
    */
    void imprimir() {
        System.out.println("Tipo Auomovil = " + motorAuto);
    ...
    */
    public static void main(String args[]) {
        ...
        final Automóvil auto1 = new


        Automóvil(tipoMotor.AUTOMATICO ,"Ford",2018,3,tipoCom.DIESEL,tipoA.EJECUTIVO,5,6,250,tipoColor.NEGRO);
        auto1.imprimir();
